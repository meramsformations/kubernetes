...
kubectl apply -f ~/kubernetes/exercice-14/curl.yaml
kubectl apply -f ~/kubernetes/exercice-14/simple-webapp-1.yaml
kubectl apply -f ~/kubernetes/exercice-14/webapp-service.yaml
