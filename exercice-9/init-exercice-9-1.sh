...
kubectl apply -f ~/kubernetes/exercice-9/ubuntu-sleeper.yaml
kubectl apply -f ~/kubernetes/exercice-9/ubuntu-sleeper-2.yaml
kubectl apply -f ~/kubernetes/exercice-9/ubuntu-sleeper-3.yaml
